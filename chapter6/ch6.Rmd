...
# adjusted R-squared and BIC also available
...
predict.regsubsets=function(object,newdata,id,...){
  ...
  # matrix multiplication; this is equivalent to X * Beta (element-wise
  # multiplication)
...
cv.ridge=cv.glmnet(x,y,alpha=0) # ridge regression; between 0 and 1 you get mix of ridge and lasso
plot(cv.ridge)
```
